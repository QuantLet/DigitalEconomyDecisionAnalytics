...
"""
Here the way to download dircetly from Yahoo finance for newer data
you may have to install yfinance
...
aapl = yf.download('AAPL', start='2020-01-01', end='2026-04-05')
